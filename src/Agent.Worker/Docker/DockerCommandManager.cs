...
namespace Microsoft.VisualStudio.Services.Agent.Worker.Docker
{
    ...
    public class DockerCommandManager : AgentService, IDockerCommandManager
    {
        ...
        {
            string dockerArgs = $"--name {context.Docker.ContainerName} --rm -v {context.Variables.Agent_WorkFolder}:{context.Variables.Agent_WorkFolder} {image} ping 127.0.0.1 -i 86400 -q";
